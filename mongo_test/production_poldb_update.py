...
conn = MongoClient('mongodb://dds-bp1a872c3a5f4df41.mongodb.rds.aliyuncs.com:3717,dds-bp1a872c3a5f4df42.mongodb.rds.aliyuncs.com:3717/admin?')
conn.admin.authenticate('root', '7swEe9croCWtJEXc')
db = conn['ztest']
coll = db.bulk1
